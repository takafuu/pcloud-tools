...
- `transfer real-gate` also exposes `human gate status`: blocked final-review reports `not-yet`, pending approvals report `required-before-real-gate`, and complete read-only approvals report `required-before-implementation`
