...
GATES: dict[str, GateSpec] = {
    ...
    "mode.switch": GateSpec(
        name="mode.switch",
        env_var="PCLOUD_TOOLS_MODE_SWITCH_GATE",
        expected_value="operator-approved-mode-switch-v1",
        approval_flags=(
        ...
        summary="exclusive mode switch",
    ),
    "autosync.launchd": GateSpec(
        name="autosync.launchd",
        env_var="PCLOUD_TOOLS_AUTOSYNC_LAUNCHD_GATE",
        expected_value="operator-approved-autosync-launchd-v1",
        approval_flags=(
        ...
        summary="autosync launchd changes",
    ),
    "sync.migration": GateSpec(
        name="sync.migration",
        env_var="PCLOUD_TOOLS_SYNC_MIGRATION_GATE",
        expected_value="operator-approved-sync-migration-v1",
        approval_flags=(
        ...
        summary="sync migration validation",
    ),
    "archive.old-monolith": GateSpec(
        name="archive.old-monolith",
        env_var="PCLOUD_TOOLS_OLD_MONOLITH_ARCHIVE_GATE",
        expected_value="operator-approved-old-monolith-archive-v1",
        approval_flags=(
