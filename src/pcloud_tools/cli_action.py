...
_ACTION_DISPATCH: dict[str, tuple[str, ...]] = {
    ...
    "trash.status.refresh": ("trash", "status", "--xbar"),
    "trash.search": ("trash", "search"),
    "trash.apply.preview": ("trash", "apply"),
    "pushd.trash.status.refresh": ("pushd", "trash", "status", "--xbar"),
    "pushd.trash.search": ("pushd", "trash", "search"),
    "pushd.trash.apply.preview": ("pushd", "trash", "apply"),
